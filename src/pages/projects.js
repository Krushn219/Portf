...
const FeaturedProjects = ({ type, title, summary, img, link, github }) => {
  return (
    <article
     ...
     bg-light shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light lg:flex-col 
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Krushn | Projects Page</title>
        <meta name="Projects" content="Back End Developer" />
      </Head>
      <TransitionEffect />
